...
def transcribir_con_gemini(project_id, location, gcs_uri):
    ...
    text1 = types.Part.from_text(text="""Por favor, transcribe el siguiente audio con la mayor precisión posible.
                                 Si no detectas audio ni palabras no generes ninguna transcripcion.
                                 El audio es de una video llamada entre un tutor educativo que da una clase a profesores en El Salvador en español.
